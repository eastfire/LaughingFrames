define(function(require, exports, module) {
	var words = ["阿里巴巴","阿童木","阿拉伯","艾佛尔铁塔", "奥斯卡金像奖", "埃及", "奥巴马", "奥林匹克", "澳门", "安全出口",//a
		"变色龙","暴风雨","博士","板凳","变形金刚","兵马俑","冰山","冰块","保龄球","扳手","比萨斜塔","鼻子", "鼻环", "笔记本", "菠萝","博物馆",//b
		"草莓","床","储蓄罐","磁铁","瓷器","长城","厕所","厨师","裁判","超人", "草原", "长城", "嫦娥",//c
		...
		"计算机","戒指","镜子","橘子","警察","机器人","僵尸","积木","肌肉","奖杯","击剑", "金字塔","聚宝盆",//j
		"筷子","可乐","孔雀","矿场","烤肉","空调","裤子","快餐","裤子", "快餐", "科学家",//k
